...
// ANSWER: No, if the return is an array

function ngetNumSquare(numbers){
  let answers = []
  for(let i =0; i < numbers.length; i++){
    let squareValue = numbers[i] * numbers[i]
  }
}
...
// ANSWER: string has a complexity of O(n). Object has a constant varible => space complexity of both are O(n)
